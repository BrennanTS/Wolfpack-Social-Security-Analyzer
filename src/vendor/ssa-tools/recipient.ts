// @ts-nocheck
import { Birthdate, type SerializedBirthdate } from './birthday';
...
import type { GenderOption } from './life-tables';
import { Money } from './money';
import { type MonthDate, MonthDuration } from './month-time';
import { type PiaInput, PrimaryInsuranceAmount } from './pia';
import { type RecipientColors, recipientColors } from './recipient-colors';
