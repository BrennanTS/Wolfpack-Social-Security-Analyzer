...
describe('HouseholdSection — the printed claiming grid', () => {
  const grid: ClaimingGrid = {
    ...
    cells: [
      { years: [62, 62], ages: [{ years: 62, months: 1 }, { years: 62, months: 1 }], value: 900, valueNominal: 900, rank: 900 },
      { years: [62, 70], ages: [{ years: 62, months: 1 }, { years: 70, months: 0 }], value: 980, valueNominal: 980, rank: 980 },
      { years: [70, 62], ages: [{ years: 70, months: 0 }, { years: 62, months: 1 }], value: 995, valueNominal: 995, rank: 995 },
      { years: [70, 70], ages: [{ years: 70, months: 0 }, { years: 70, months: 0 }], value: 1000, valueNominal: 1000, rank: 1000 },
    ],
    max: 1000,
    min: 900,
  };
