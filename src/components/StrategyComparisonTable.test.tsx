...
const comparisons: HouseholdStrategy[] = [
  { key: 'earliest', label: 'Both claim earliest (62)', filingAges: [age(62), age(62)],
    expectedNpv: 1_018_000, timeline: [], householdValue: 1_018_000, lifetimeTotal: null, survivorClaimDate: null,
  ...
  { key: 'optimal', label: 'Optimal', filingAges: [age(70), age(64)],
    expectedNpv: 1_243_000, timeline: [], householdValue: 1_243_000, lifetimeTotal: null, survivorClaimDate: null,
  ...
  { key: 'latest', label: 'Both delay to 70', filingAges: [age(70), age(70)],
    expectedNpv: 1_221_000, timeline: [], householdValue: 1_221_000, lifetimeTotal: null, survivorClaimDate: null,
